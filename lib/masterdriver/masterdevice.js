...
class masterDevice extends Homey.Device {
    ...
    onInit() {
        ...
        this.checkUpdateInterval = 36000000
          ...
          //#region  driver appDriver

        if (this.driver == `app`) {
            Homey.app.settings = this.settings
            this.log(`Homey.app.settings ${util.inspect(Homey.app.settings)}`)
        ...
        if (this.driver == 'X10') {
            ...
            // register a capability listener
            {
                ...
                this.onCapabilityOnoff = (value, opts, callback) => {
                    ...
                    Homey.app.signalX10.processSendCommand(sendCommand)
    ...
    onSettings(oldSettingsObj, newSettingsObj, changedKeysArr, callback) {
        ...
        if (changedKeysArr.includes(`setHomeyRfX10On`)) {

            this.log(`before  setHomeyRfX10On Changed  app settings  ${util.inspect(Homey.app.settings)}          `)

            Homey.app.settings.setHomeyRfX10On = newSettingsObj.setHomeyRfX10On

            this.log(`after  setHomeyRfX10On Changed aspp settings  ${util.inspect(Homey.app.settings)}          `)


        }

        if (changedKeysArr.includes(`setHomeyOregonRfOn`)) {

            this.log(`before  setHomeyRfX10On Changed  app settings  ${util.inspect(Homey.app.settings)}          `)

            Homey.app.settings.setHomeyOregonRfOn = newSettingsObj.setHomeyOregonRfOn
        ...
        if (changedKeysArr.includes(`setPlugwiseOn`)) {

            this.log(`before  setHomeyRfX10On Changed  app settings  ${util.inspect(Homey.app.settings)}          `)

            Homey.app.settings.setPlugwiseOn = newSettingsObj.setPlugwiseOn
        ...
        if (changedKeysArr.includes(`ipPlugwise`)) {

            this.log(`before  setHomeyRfX10On Changed  app settings  ${util.inspect(Homey.app.settings)}          `)

            Homey.app.settings.ipPlugwise = newSettingsObj.ipPlugwise
        ...
        if (changedKeysArr.includes(`portPlugwise`)) {

            this.log(`before  setHomeyRfX10On Changed  app settings  ${util.inspect(Homey.app.settings)}          `)

            Homey.app.settings.portPlugwise = newSettingsObj.portPlugwise
        ...
        if (changedKeysArr.includes(`setProliphixOn`)) {

            this.log(`before  setHomeyRfX10On Changed  app settings  ${util.inspect(Homey.app.settings)}          `)

            Homey.app.settings.setProliphixOn = newSettingsObjsetProliphixOn
        ...
        if (changedKeysArr.includes(`ipProliphix`)) {

            this.log(`before  setHomeyRfX10On Changed  app settings  ${util.inspect(Homey.app.settings)}          `)

            Homey.app.settings.ipProliphix = newSettingsObj.ipProliphix
        ...
        if (changedKeysArr.includes(`portProliphix`)) {

            this.log(`before  setHomeyRfX10On Changed  app settings  ${util.inspect(Homey.app.settings)}          `)

            Homey.app.settings.portProliphix= newSettingsObj.  portProliphix
            this.log(`after  setHomeyRfX10On Changed aspp settings  ${util.inspect(Homey.app.settings)}          `)
